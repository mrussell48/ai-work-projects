...
def calculates_results_stats(results_dic):
    ...
    n_images = n_dogs_img = n_notdogs_img = n_match = n_correct_dogs = n_correct_notdogs = n_correct_breed = 0
    ...
    calculates_results_stats["pct_match"] = n_match / n_images * 100
    calculates_results_stats["pct_correct_dogs"] = n_correct_dogs / n_dogs_img * 100
    calculates_results_stats["pct_correct_breed"] = n_correct_breed / n_dogs_img * 100
    
    if n_notdogs_img > 0:
        calculates_results_stats["pct_correct_notdogs"] = n_correct_notdogs / n_notdogs_img * 100 
    else:
        calculates_results_stats["pct_correct_notdogs"] = 0
